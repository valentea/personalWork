...
:No help from teachers/TAs. Minimal talk with my roommates (also in CS103).
=============================== Prelab ==================================
...
:right before you update 'currentPoint'.
...
:28x60 maze. Quite complicated, took my roommates aprximently 3 min each
  to find solution. My maze has a couple ways to finish (as descoverd by my
  roommates) but the progam finds the most effishent way.
...
: Quite a fiew segfalts, but nothing to extream.
